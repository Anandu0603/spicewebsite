...
const Admin: React.FC = () => {
  ...
  const orders: Order[] = [
    {
      ...
      products: 'Premium Green Cardamom',
      quantity: 2,
      total: 2400,
      status: 'pending',
      date: '2025-01-12'
  ...
  const products: Product[] = [
    ...
    { id: 'PRD-004', name: 'Ceylon Cinnamon', price: 400, stock: 15, category: 'Cinnamon', status: 'active' },
  ];
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-600">Manage your spice business efficiently</p>
        </motion.div>
